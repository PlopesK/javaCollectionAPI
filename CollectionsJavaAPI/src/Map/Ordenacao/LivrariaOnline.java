...
public class LivrariaOnline {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nLivro(s) mais caro(s): " + livrariaOnline.obterLivroMaisCaro());

        System.out.println("\nLivro(s) mais barato(s): " + livrariaOnline.obterLivroMaisBarato());

        livrariaOnline.removerLivro("1984");

        System.out.println("\nTodos os livros: " + livrariaOnline.obterLivroMaisCaro());
